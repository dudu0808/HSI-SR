...
def main():
    ...
    subset = 'train'
    rcan_weights_path = r"/home/shiyanshi/dbq/models_ECCV2018RCAN/RCAN_BIX4.pt"
    sr_scale = 4
    output_dir = 'output_data'
    os.makedirs(output_dir, exist_ok=True)
    lr_rgb_output_path = r"/home/shiyanshi/dbq/DualSR-master/dubingqingnet/model/output_data/lr_rgb_32.jpg"
    hr_rgb_output_path = r"/home/shiyanshi/dbq/DualSR-master/dubingqingnet/model/output_data/hr_rgb_128.jpg"
    ...
    with torch.no_grad():
        ...
        os.makedirs(os.path.dirname(lr_rgb_output_path), exist_ok=True)
        ...
        os.makedirs(os.path.dirname(hr_rgb_output_path), exist_ok=True)
        ...
        hr_hsi_output_path = os.path.join(output_dir, f'hr_hsi_64x{actual_lr_h * sr_scale}x{actual_lr_w * sr_scale}.npy')
        save_hsi_data(hr_hsi_output, hr_hsi_output_path)
...
def demo():
    ...
    try:
        ...
        print(f"\n演示中止: {e}")
        print("请检查 .mat 文件的结构。CustomMatDataset 期望 'Z' 变量具有特定形状。")
